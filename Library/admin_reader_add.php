    ...
    <form  action="admin_reader_add.php" method="POST" style="text-align: center" class="bs-example bs-example-form" role="form">
        <div id="login">
            <div class="input-group">
                ...
                <input name="nid" type="text" placeholder="请输入读者证号" class="form-control">
            </div><br/>
            <div class="input-group">
                <span class="input-group-addon">读者姓名</span>
                <input name="nname" type="text" placeholder="请输入读者姓名" class="form-control">
            </div><br/>
<!--            <div class="input-group">-->
<!--                <span class="input-group-addon">性别</span>-->
<!--                <input name="nsex" type="text" placeholder="请输入读者性别" class="form-control">-->
<!--            </div><br/>-->
            <div class="form-group">
                <label name="nsex">性别</label>
            ...
            <div class="input-group">
                <span class="input-group-addon">读者生日</span>
                <input name="nbirth" type="text" placeholder="请输入读者生日" class="form-control">
            </div><br/>
            <div class="input-group">
                <span class="input-group-addon">读者地址</span>
                <input name="naddress" type="text" placeholder="请输入读者地址" class="form-control">
            </div><br/>
            <div class="input-group">
                <span class="input-group-addon">读者电话</span>
                <input name="ntel" type="text" placeholder="请输入读者电话" class="form-control">
            </div><br/>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $sqlb="insert into reader_card (reader_id,name,passwd) VALUES($nnid ,'{$nnam}',md5('111111));";
