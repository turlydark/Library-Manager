...
if($resulta['card_state']==0)
    echo "挂失<br/><br/><a href='reader_guashi_do.php?id=0' style='text-align: center'>点此取消挂失</a>";
else
    echo "正常<br/><br/><a href='reader_guashi_do.php?id=1' style='text-align: center'>点此挂失</a>";
